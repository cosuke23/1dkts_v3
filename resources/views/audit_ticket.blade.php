...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card">
                <div class="card-header" style="background-color:#43A6C6;font-family:Bold;font-size:20px;">{{ __('Ticket Audit Trail Dashboard') }}</div>
...
<table id="datatable" class="table table-striped table-bordered table-responsive table-hover" > 
        <thead>  
           <tr >
    <th style="width:14.28%;">Ticket No.</th>
    ...
    <th style="width:14.28%;">Action By</th>
    <th style="width:14.28%;">Action Taken</th>
    <th style="width:14.28%;">Date Created</th>
  </thead>
  </tr>
