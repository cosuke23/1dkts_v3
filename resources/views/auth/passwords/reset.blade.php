                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="password" id="psw" onkeyup='check();'name="password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!\@\$\%\^\&\*\(\)\_\-\?\=\+\<\>\.\,]).{8,}" required><button class="btn btn-outline-dark" type="button"
...
$('#psw, #txtConfirmPassword').on('keyup', function() {
  if ($('#psw').val() == $('#txtConfirmPassword').val()) {
    $('#messages').html('Password matched').css('color', 'green');
    $('#submit').prop('disabled', false);
  } else {
    $('#messages').html('Password does not match').css('color', 'red');
